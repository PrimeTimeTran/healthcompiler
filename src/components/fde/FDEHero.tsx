...
const timelinePhases = [
  { week: "Week 1", title: "Discovery & Design", tasks: ["Data audit", "Workflow mapping", "Success metrics"] },
  { week: "Week 2–3", title: "Build & Integrate", tasks: ["Pipeline setup", "API connections", "Testing"] },
  { week: "Week 4+", title: "Deploy & Optimize", tasks: ["Go live", "Training", "Iteration"] },
];
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-lg">
                We embed with your team to ship healthcare data + workflow outcomes in weeks—not quarters.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-card/50 backdrop-blur-xl border border-border/50 rounded-3xl p-8 shadow-elevated">
              ...
              <div className="relative mb-8">
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-widest">Deployment Timeline</p>
              </div>
