...
const features = [
  { icon: FileCheck, label: 'Vendor accountability', description: 'Track vendor performance and compliance' },
  { icon: Scale, label: 'Spend justification', description: 'Document and justify every dollar spent' },
  { icon: BarChart3, label: 'Benchmarking', description: 'Compare against industry standards' },
  { icon: FileText, label: 'Documentation trails', description: 'Complete audit-ready documentation' },
];
    ...
    <section className="py-20 md:py-28 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Fiduciary-Grade Oversight</h2>
