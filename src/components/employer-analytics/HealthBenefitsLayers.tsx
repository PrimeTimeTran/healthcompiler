...
import { DollarSign, Pill, Stethoscope, Shield, TrendingUp, Users, BarChart3, Target } from 'lucide-react';
            ...
            <div className="relative w-full max-w-lg mx-auto" style={{ perspective: '1000px' }}>
              {layers.map((layer, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${layer.color} ${
