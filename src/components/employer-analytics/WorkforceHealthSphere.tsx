    ...
    <section className="py-20 md:py-28 bg-muted/30 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Workforce Health Analytics</h2>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">
                      {index === 0 && 'Track chronic disease burden across your population'}
                      {index === 1 && 'Identify avoidable healthcare spend'}
                      {index === 2 && 'Monitor care access and utilization patterns'}
                      {index === 3 && 'Measure employee engagement with health programs'}
                    </p>
                  </div>
                </div>
              ))}
