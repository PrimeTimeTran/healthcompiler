import { Workflow, Stethoscope, ClipboardCheck, Zap, Shield } from 'lucide-react';

const features = [
  { icon: Workflow, label: 'Seamless integration', description: 'Fits into existing clinical workflows' },
  { icon: Stethoscope, label: 'Care management', description: 'Designed for care teams and managers' },
  { icon: ClipboardCheck, label: 'Actionable insights', description: 'Clear, actionable data without complexity' },
  { icon: Zap, label: 'Real-time updates', description: 'Continuous visibility, not periodic snapshots' },
];
    ...
    <section className="py-20 md:py-28 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Built for Real-World Population Health Workflows</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Clear, actionable insights without added operational burden. Health outcomes intelligence designed to fit seamlessly into daily clinical and care management workflows.
          </p>
        </div>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative">
              ...
              <svg viewBox="0 0 200 200" className="w-64 h-64 md:w-80 md:h-80 relative z-10">
                ...
                {/* Inner rings */}
                <circle cx="100" cy="100" r="60" fill="none" stroke="hsl(var(--primary))" strokeWidth="1" strokeOpacity="0.3" strokeDasharray="4 4" />
                <circle cx="100" cy="100" r="40" fill="none" stroke="hsl(var(--primary))" strokeWidth="1" strokeOpacity="0.5" strokeDasharray="4 4" />
                  ...
                  return (
                    <g key={i}>
                      <line
                        ...
                        strokeOpacity="0.4"
                      />
                      <circle r="4" fill="hsl(var(--primary))" opacity="0.7">
                        <animateMotion
                          dur={`${2 + i * 0.3}s`}
                ...
                <text x="100" y="106" textAnchor="middle" fill="hsl(var(--primary))" fontSize="20">⚡</text>
              </svg>
