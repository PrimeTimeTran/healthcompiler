    ...
    <section className="py-20 md:py-28 bg-muted/30 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Proactive Care Matters</h2>
        ...
        <div className="max-w-4xl mx-auto">
              ...
              return (
                <div key={index} className="flex items-center">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-4 font-semibold text-sm">{step.label}</span>
                  </div>
          ...
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <p className="text-lg text-foreground">
              <span className="font-semibold text-primary">Early visibility</span> enables{' '}
              <span className="font-semibold text-primary">proactive care</span>.
            </p>
            <p className="text-lg text-foreground">
              <span className="font-semibold text-primary">Proactive care</span> leads to better outcomes, lower utilization, and stronger continuity of care.
            </p>
          </div>
