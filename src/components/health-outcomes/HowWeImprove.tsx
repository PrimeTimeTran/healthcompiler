...
const outcomes = [
  { icon: TrendingUp, label: 'Patients improving', color: 'text-green-500', description: 'Patients whose outcomes are improving' },
  { icon: Activity, label: 'Clinically stable', color: 'text-cyan-500', description: 'Patients who remain clinically stable' },
  { icon: AlertTriangle, label: 'Early risk signals', color: 'text-orange-500', description: 'Patients showing early risk signals requiring proactive outreach' },
  { icon: CheckCircle, label: 'Better coordination', color: 'text-purple-500', description: 'This enables earlier intervention, better care coordination, and measurable improvement in outcomes' },
];
    ...
    <section className="py-20 md:py-28 bg-muted/30 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">How Health Compiler Improves Health Outcomes</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Health Compiler provides continuous population health visibility, not point-in-time snapshots. Care teams can quickly identify:
          </p>
        </div>
