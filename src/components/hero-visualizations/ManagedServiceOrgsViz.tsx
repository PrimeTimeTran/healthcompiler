...
const ManagedServiceOrgsViz = () => {
  ...
  const metrics = [
    { icon: Building2, label: 'Practices', value: '24 managed', color: '#06B6D4' },
    { icon: GitBranch, label: 'Workflows', value: 'Unified', color: '#8B5CF6' },
    { icon: BarChart3, label: 'Performance', value: '+34% avg', color: '#10B981' },
      ...
      <div className='relative'>
        ...
        <div className='relative bg-white rounded-2xl border border-cyan-500/20 shadow-2xl p-6 w-[180px]'>
          ...
          <div className='relative space-y-4 text-center'>
            <div className='w-14 h-14 mx-auto rounded-full bg-gradient-to-br from-cyan-500 to-emerald-500 flex items-center justify-center'>
