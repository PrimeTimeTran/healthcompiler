  ...
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center">
      <svg viewBox="0 0 400 400" className="w-full h-full max-w-md">
        <defs>
          <linearGradient id="progressCoreGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Background rings */}
        <circle cx="200" cy="200" r="160" fill="none" stroke="hsl(var(--border))" strokeWidth="1" strokeDasharray="4 4" opacity="0.3" />
        <circle cx="200" cy="200" r="120" fill="none" stroke="hsl(var(--border))" strokeWidth="1" strokeDasharray="2 2" opacity="0.2" />
          ...
          return (
            <g key={`label-${stage.label}`}>
              ...
              <text 
                ...
                y={y + 4} 
                textAnchor="middle" 
                className={`text-[8px] font-medium ${isActive ? 'fill-white' : 'fill-muted-foreground'}`}
              >
                {stage.label}
              </text>
            </g>
        ...
        <g>
          ...
          <text x="200" y="195" textAnchor="middle" className="fill-white text-[11px] font-semibold">
            Long-Term
          </text>
          <text x="200" y="210" textAnchor="middle" className="fill-white/80 text-[9px]">
            Progress
          </text>
        </g>

        {/* Pulse effect */}
        <circle cx="200" cy="200" r="50" fill="none" stroke="hsl(var(--primary))" strokeWidth="1" opacity="0">
...
const MedicalWeightLoss = () => {
  const journeyBenefits = [
    ...
    { icon: Handshake, text: "Share clear progress with patients and partners" }
  ];
  ...
  const solutions = [
    {
      ...
      description: "See engagement, utilization, and outcome trends across your patient population. Designed to support proactive care and long-term progress."
    },
    {
      icon: Bot,
      title: "AI Support for Communication and Triage",
      description: "AI support for new inquiries and ongoing triage, helping teams keep up with calls, questions, and follow-ups from patients."
    },
    {
      icon: Megaphone,
      title: "Marketing Automation for Program Growth",
      description: "Consistent follow-ups and outreach without extra manual effort. Designed to support patient education, retention, and steady program growth."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
                Clear Insight for{' '}
                <span className="text-primary">Long-Term Weight Loss Progress</span>
              </h1>
              
              <p className="text-xl text-muted-foreground mb-8">
                Clear data helps teams understand what is working, where patients disengage, and when support is needed.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Track adherence and outcomes across the patient journey. Bringing that information together makes it easier to:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {journeyBenefits.map((benefit, index) => (
                <div key={index} className="flex items-start gap-4 p-6 bg-muted/30 rounded-xl border border-border/50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-background rounded-2xl p-8 shadow-sm border border-border hover:border-primary/30 transition-colors group">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              Health Compiler integrates with the tools medical weight-loss teams already use.
            </p>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 p-8 bg-muted/30 rounded-2xl border border-border/50">
              {integrationLogos.map((logo, index) => (
                <div key={index} className="h-12 w-32 bg-background rounded-lg flex items-center justify-center p-2 shadow-sm">
                  <img 
                    src={logo.src} 
                    alt={logo.name} 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Medical weight loss depends on sustained engagement and measurable progress.
              </p>
              <p className="text-lg text-foreground font-medium">
                Clear insight helps teams stay aligned, patients stay supported, and outcomes stay visible.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-8 border border-primary/20">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-background rounded-xl p-4 text-center shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Get started with clear insights for your medical weight loss program.
            </p>
