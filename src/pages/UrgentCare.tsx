                ...
                <g key={`loc-${idx}`}>
                  <circle
                    ...
                    style={{
                      filter:
                        idx === activeLocation
                          ? 'drop-shadow(0 0 10px rgba(233, 78, 135, 0.3))'
                          : 'none',
                    }}
                  />
                  <text
...
const ProblemSection = () => {
  const problems = [
    ...
    {
      icon: AlertTriangle,
      text: 'Fragmented EHR, billing, and reporting systems',
    },
    {
      icon: BarChart3,
      text: 'Limited insight into site-level performance and downstream outcomes',
    },
  ]
        ...
        <div className='mt-16 flex justify-center gap-4'>
          {[0, 1, 2, 3].map((i) => (
            <div
              ...
              style={{
                transform: `rotate(${(i - 1.5) * 3}deg) translateY(${
                  Math.abs(i - 1.5) * 4
                }px)`,
              }}
            />
        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          <div className='space-y-8'>
            ...
            <p className='text-muted-foreground'>
              Health Compiler applies AI to surface signals and automate insight
              generation without disrupting frontline workflows.
            </p>
    ...
    <section className='py-24 bg-white'>
      <div className='container mx-auto px-6'>
        <div className='text-center mb-12'>
          ...
          <p className='text-muted-foreground'>
            No rip-and-replace. Health Compiler integrates with EHRs, billing
            systems, labs, and employer platforms.
          </p>
        </div>
