...
const GetFeatured = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success('Thank you! Your submission has been received. We\'ll be in touch soon.');
    ...
    <Layout>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-b from-background to-background-secondary">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm uppercase tracking-widest text-accent mb-4">APEX Magazine</p>
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
            Get <span className="text-gradient">Featured</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Share your story with the APEX community. We feature change makers in Direct Primary Care, 
            Direct Specialty Care, and Self-Funded Benefits Advisory.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  APEX Magazine celebrates the innovators and change makers who are transforming 
                  healthcare delivery. Being featured connects you with a community of like-minded 
                  professionals and amplifies your impact.
                </p>
              </div>
              ...
              <div className="bg-secondary rounded-2xl p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  <a href="mailto:apex@healthcompiler.com" className="text-accent hover:underline">
