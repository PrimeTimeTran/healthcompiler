            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Whether you're looking to modernize your healthcare data infrastructure, 
                  build custom analytics solutions, or automate operational workflows—we're here to help.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">hello@healthcompiler.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">United States (Remote-first)</p>
                  </div>
                </div>
              </div>
